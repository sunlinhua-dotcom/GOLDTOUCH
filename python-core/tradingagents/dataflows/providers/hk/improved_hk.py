...
class ImprovedHKStockProvider:
    ...
    def __init__(self):
        ...
        # 内置港股名称和行业映射（避免API调用 + 补充缺失行业信息）
        # 格式: 'code': {'name': '名称', 'industry': '行业', 'sector': '板块'}
        self.hk_stock_names = {
            # 腾讯系
            '0700.HK': {'name': '腾讯控股', 'industry': '互联网及软件', 'sector': '科技'},
            '0700': {'name': '腾讯控股', 'industry': '互联网及软件', 'sector': '科技'},
            '00700': {'name': '腾讯控股', 'industry': '互联网及软件', 'sector': '科技'},
            '00772.HK': {'name': '阅文集团', 'industry': '互联网服务', 'sector': '科技'}, # User Request
            '00772': {'name': '阅文集团', 'industry': '互联网服务', 'sector': '科技'},
            
            # 科技巨头
            '9988.HK': {'name': '阿里巴巴', 'industry': '电商与互联网', 'sector': '科技'},
            '3690.HK': {'name': '美团', 'industry': '生活服务', 'sector': '消费科技'},
            '1024.HK': {'name': '快手', 'industry': '软件服务', 'sector': '科技'},
            '1810.HK': {'name': '小米集团', 'industry': '消费电子', 'sector': '科技'},
            '01810': {'name': '小米集团', 'industry': '消费电子', 'sector': '科技'},
            '9888.HK': {'name': '百度集团', 'industry': '互联网服务', 'sector': '科技'},
            '09888': {'name': '百度集团', 'industry': '互联网服务', 'sector': '科技'},
            '9618.HK': {'name': '京东集团', 'industry': '电商与物流', 'sector': '消费科技'},
            
            # 电信运营商
            '0941.HK': {'name': '中国移动', 'industry': '电信服务', 'sector': '公用事业'},
            '0762.HK': {'name': '中国联通', 'industry': '电信服务', 'sector': '公用事业'},
            '0728.HK': {'name': '中国电信', 'industry': '电信服务', 'sector': '公用事业'},
            
            # 银行
            '0939.HK': {'name': '建设银行', 'industry': '银行', 'sector': '金融'},
            '1398.HK': {'name': '工商银行', 'industry': '银行', 'sector': '金融'},
            '3988.HK': {'name': '中国银行', 'industry': '银行', 'sector': '金融'},
            '0005.HK': {'name': '汇丰控股', 'industry': '银行', 'sector': '金融'},
            
            # 保险
            '1299.HK': {'name': '友邦保险', 'industry': '保险', 'sector': '金融'},
            '2318.HK': {'name': '中国平安', 'industry': '保险', 'sector': '金融'},
            '2628.HK': {'name': '中国人寿', 'industry': '保险', 'sector': '金融'},
            
            # 汽车
            '2238.HK': {'name': '广汽集团', 'industry': '汽车制造', 'sector': '可选消费'},
            '1211.HK': {'name': '比亚迪股份', 'industry': '汽车制造', 'sector': '可选消费'},
            '01211': {'name': '比亚迪股份', 'industry': '汽车制造', 'sector': '可选消费'},
            '2015.HK': {'name': '理想汽车', 'industry': '汽车制造', 'sector': '可选消费'},
            '09868.HK': {'name': '小鹏汽车', 'industry': '汽车制造', 'sector': '可选消费'},
            '09866.HK': {'name': '蔚来', 'industry': '汽车制造', 'sector': '可选消费'},

            # 石油化工
            '0857.HK': {'name': '中国石油', 'industry': '石油天然气', 'sector': '能源'},
            '0386.HK': {'name': '中国石化', 'industry': '石油天然气', 'sector': '能源'},
            '0883.HK': {'name': '中国海洋石油', 'industry': '石油天然气', 'sector': '能源'},
        }
        ...
        try:
            ...
            for format_symbol in [symbol, normalized_symbol, f"{normalized_symbol}.HK"]:
                if format_symbol in self.hk_stock_names:
                    stock_data = self.hk_stock_names[format_symbol]
                    # Handle both new dict format and old string format for backward compatibility
                    company_name = stock_data['name'] if isinstance(stock_data, dict) else stock_data
